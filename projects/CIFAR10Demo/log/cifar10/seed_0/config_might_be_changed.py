...
def get_config(gpu=0, seed=42):
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptutils/CrossEntropyLoss.py'
    item['params'] = {}
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptutils/Lamb2.py'
    item['params'] = {
        'lr' : lr_init, 
        'betas' : (0.9, 0.999),
        'weight_decay' : 1.,
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/projects/CIFAR10Demo/scripts/TransformCIFARTrainBaseline.py'
    item['params'] = {
        'norm_mean' :  norm_mean, 
        'norm_std' : norm_std,
        }
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/projects/CIFAR10Demo/scripts/TransformCIFARTest.py'
    item['params'] = {
        'norm_mean' :  norm_mean, 
        'norm_std' : norm_std,
        }
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/projects/CIFAR10Demo/scripts/CIFAR10.py'
    item['params'] = {
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorchtools/ptutils/DataloaderGetter.py'
    item['params'] = {
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerTrainingInitializationModule.py'
    item['params'] = {}


    item = {}; config['scheduler_modules']['scheduler_trainer'] = item
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerTrainingModule.py'
    item['params'] = {}


    item = {}; config['scheduler_modules']['scheduler_validator'] = item
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerValidationModule.py'
    item['params'] = {
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerSaveNetModule.py'
    item['params'] = {}


    item = {}; config['scheduler_modules']['scheduler_lr'] = item
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerLearningRateModifierModule.py'
    item['params'] = {
        'schedule' : {
    ...
    item['source'] = '/nfshome/linse/Documents/development/pytorch_classification/pytorchtools/ptschedulers/SchedulerLogOutputModule.py'
    item['params'] = {
        'loader' : 'loader_test',
